...
\subsection*{Leonardo Tassinari}
The only point I'd like to raise here is regarding how the correction of the lab practices is managed in class: each time you finish an exercise you have to raise your hand and wait for an undefined amount of time.
